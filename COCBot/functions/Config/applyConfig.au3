	...
	Switch $TypeReadSave
		...
		Case "Save"
			...
			For $i = 0 To 2
				...
				$g_aiDonateCustomTrpNumE[$i][0] = _GUICtrlComboBox_GetCurSel($g_ahCmbDonateCustomE[$i])
				$g_aiDonateCustomTrpNumE[$i][1] = GUICtrlRead($g_ahTxtDonateCustomE[$i])
				$g_aiDonateCustomTrpNumF[$i][0] = _GUICtrlComboBox_GetCurSel($g_ahCmbDonateCustomF[$i])
				$g_aiDonateCustomTrpNumF[$i][1] = GUICtrlRead($g_ahTxtDonateCustomF[$i])
				$g_aiDonateCustomTrpNumG[$i][0] = _GUICtrlComboBox_GetCurSel($g_ahCmbDonateCustomG[$i])
				$g_aiDonateCustomTrpNumG[$i][1] = GUICtrlRead($g_ahTxtDonateCustomG[$i])
				$g_aiDonateCustomTrpNumH[$i][0] = _GUICtrlComboBox_GetCurSel($g_ahCmbDonateCustomH[$i])
				$g_aiDonateCustomTrpNumH[$i][1] = GUICtrlRead($g_ahTxtDonateCustomH[$i])
			Next
